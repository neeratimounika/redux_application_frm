  ...
  return (
    ...
    <div className='container'>
      ...
      <div className='row'>
        <div className='col-4'>
            <input 
            className='form-control'type='number' placeholder='Enter Amount' 
            value={amount}
            onChange={(e)=>{
      ...
      <div className='row mt-2'>
        <div className='col-4'>
            <input 
            className='form-control'type='text' placeholder='Enter FullName' 
            value={fullName}
            onChange={(e)=>{
                let data = e.target.value;
                setFullName(data)
      ...
      <div className='row mt-2'>
        <div className='col-4'>
            <input 
            className='form-control'type='number' placeholder='Enter MobileNo' 
            value={mobile}
            onChange={(e)=>{
                let data = e.target.value;
                setMobile(data)
